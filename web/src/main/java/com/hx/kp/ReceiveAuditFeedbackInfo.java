...
/**
 * <p>receiveAuditFeedbackInfo complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="receiveAuditFeedbackInfo"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "receiveAuditFeedbackInfo", propOrder = {
    "evxmlsize",
    "evreserve1",
    "evreserve2",
    "etreturn"
})
public class ReceiveAuditFeedbackInfo {
